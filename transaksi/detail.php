...
$sql = "SELECT * FROM peminjaman INNER JOIN detail_pinjam dp ON p.id_pinjam=dp.id_pinjam INNER JOIN buku b ON b.id_buku=dp.id_buku where p.id_pinjam='$id_pinjam'";
			...
			<table class="table table-bordered">
				...
				<tr>
					<td class="text-rigth" colspan="2">
						<a href="form_kembali.php" class="btn btn-success"><i class="fas fa-angle-double-left"></i>Kembali</a>
						<a class="btn btn-primary<?php if($detail['tgl_kembali']!=NULL){echo "disabled";}?>" href="form_kembali.php?id_pinjam=<?=$detail['id_pinjam']?>&id_buku=<?=$detail['id_buku']?>" role="button">Form Pengembalian</a>
					</td>
				</tr>
			</table>
		</div>
